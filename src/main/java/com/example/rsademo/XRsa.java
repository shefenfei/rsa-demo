...
//        IOUtils.closeQuietly(out);
    ...
    public static void main(String[] args) {
        ...
        String content = "";
        String publicEncrypt = xRsa.publicEncrypt(content);

        System.out.println(publicEncrypt);

        String privateDecrypt = xRsa.privateDecrypt(publicEncrypt);
